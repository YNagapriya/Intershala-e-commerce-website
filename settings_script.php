<?php
	...
	if(!isset($_SESSION["email_id"])){
        ...
        $new_password = MD5(mysqli_real_escape_string($conn, filter_input(INPUT_POST,"new_pass")));
        $retype_pass = MD5(mysqli_real_escape_string($conn, filter_input(INPUT_POST,"retype_new_pass")));
